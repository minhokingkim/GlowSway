 ...
 * This file demonstrates how to integrate Glowsway with a web frontend
 */

// For React/Vue/Angular applications
export class GlowswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GlowswayClient(provider, contractAddress);
